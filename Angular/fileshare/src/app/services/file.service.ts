...
export class FileService {
  ...
  constructor(private http: HttpClient, private r: Router) { }
    ...
    public downloadFile(fullPath: string): Observable<any> {
        let myHeaders = new HttpHeaders();
        myHeaders.append('Content-Type', 'multipart/form-data');
        return this.http.get('http://localhost:4200/api/getFile' + fullPath, {headers: myHeaders, responseType: 'blob'});
    }
    ...
    public getMIMEtype(ext: string): string {
        switch(ext) {
            ...
            case 'fpx': { return 'image/vnd.net-fpx'; }
            ...
            case 'pfunk': { return 'audio/make.my.funk'; }
            ...
            case 'rng': { return 'application/vnd.nokia.ringing-tone'; }
            ...
            case 'scm': { return 'text/x-script.guile'; }
            case 'scm': { return 'text/x-script.scheme'; }
            ...
            case 'wp5': { return 'application/wordperfect6.0'; }
